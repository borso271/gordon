...
//     const SCROLL_THRESHOLD = 2000; // Adjust for sensitivity
...
//       // Prevent scrolling up on the first pair
//       if (currentIndex === 0 || currentIndex===1 && currentScrollDirection === "up") return;
  
//       // If we’ve changed direction, reset the accumulator
//       if (
//         lastScrollDirection.current &&
//         lastScrollDirection.current !== currentScrollDirection
//       ) {
...
//       console.log("scroll acc is: ", scrollAccumulator.current)
//       // Check threshold
//       if (Math.abs(scrollAccumulator.current) >= SCROLL_THRESHOLD) {
//         // Lock so we don’t fire multiple times on a big wheel event
//         isScrolling.current = true;
...
//           goNextPair();
//         } else if (scrollAccumulator.current < 0 && isAtTop) {
//           goPrevPair();
//         }
...
//   const SCROLL_THRESHOLD = 450; // Adjust for your sensitivity
