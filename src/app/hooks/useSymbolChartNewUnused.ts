...
// refactor this so that it actually takes as input the data

import { PricePoint, IntradayMap, LastPriceResult, PriceDataMap, Period} from "../../interfaces/index.js";

export function useSymbolChart(symbol: string, seriesesData,symbolInfo,snapShot, width: number, height: number) {
