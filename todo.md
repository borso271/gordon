...
2. ADD ANALYSIS RESPONSE FOR SECURITY NOT IN THE DATABASE.

Use this (if not in the database)
What it should return is, i am working on limited financial data, because I am a promo,
data is money. You can test my abilities with the following stocks...

------------------------------------------------------------------------------------------------------------------------- --------------------------- --------------------------- ----------

EASILY DOABLE:
3. GIVE THE CRUX OF THE ANALYSIS TO GPT FOR CONTEXT.
...
finally, bit harder and maybe doable tomorrow:
5. RERUN DATA FETCHING FOR THE RIGHT CRYPTOS (THE 7 CRYPTOS YOU HAVE IN THE DATABASE), AND THE OTHER STOCKS.
