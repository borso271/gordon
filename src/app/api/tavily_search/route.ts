...
export async function POST(req: NextRequest) {
  ...
  /*
  For search:
  - TRY BING IS ONE OPTION
  - USE OPENAI AND STREAM OPENAI RESPONSE RIGHT AWAY...
    NAMELY, SETTING THE ASSISTANTTEXT TO WHATEVER THE OPENAI WEB SEARCH ENDPOINT RETURN...

    MAYBE EVEN WITH STRUCTURED OUTPUT? TRY THIS IF IT WORKS...

  - THEN GIVE BACK THE RESULTS TO OPENAI SAYING: THIS IS WHAT HAS BEEN FOUND AND ALREADY SHOWN TO THE USER,
    JUST GIVE A QUCK SUMMARY OF IT.
